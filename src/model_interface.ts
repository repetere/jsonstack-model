...
export class TensorScriptModelInterface  {
   ...
   */
  async train(x_matrix: Matrix, y_matrix?: Matrix, layers?: TensorScriptLayers, x_test?: Matrix, y_test?: Matrix): Promise<tf.LayersModel|Matrix>
  async train(x_matrix:Matrix, y_matrix?:Matrix):Promise<tf.LayersModel|Matrix>
   ...
   */
  // async predict(options?:Matrix|Vector|InputTextArray|PredictionOptions):Promise<Matrix|Vector> 
