...
export declare class TensorScriptModelInterface {
     ...
     */
    train(x_matrix: Matrix, y_matrix?: Matrix, layers?: TensorScriptLayers, x_test?: Matrix, y_test?: Matrix): Promise<tf.LayersModel | Matrix>;
    train(x_matrix: Matrix, y_matrix?: Matrix): Promise<tf.LayersModel | Matrix>;
    /**
